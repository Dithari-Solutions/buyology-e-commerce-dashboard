    ...
    >
      ...
      <div className="mt-3 flex justify-end gap-2">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="inline-flex items-center gap-1.5 rounded-lg bg-[#402F75] px-4 py-1.5 text-xs font-semibold text-white hover:bg-[#332560] disabled:opacity-50 transition-colors"
        >
          {editOption
  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <button
        ...
        className="flex w-full items-center gap-3 px-4 py-2.5 text-left hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors"
      >
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 px-4 pb-4 pt-4">
                ...
                <tbody>
                  {sortedOptions.map((opt, index) => (
                    <tr key={opt.id} className="border-b border-gray-100 dark:border-gray-800 last:border-0">
                      ...
                      <td className="px-4 py-2.5 font-medium text-gray-700 dark:text-gray-300">{getOptionValue(opt, "EN")}</td>
                      <td className="px-4 py-2.5 text-gray-500 dark:text-gray-400">{getOptionValue(opt, "AZ")}</td>
                      <td className="px-4 py-2.5 text-gray-500 dark:text-gray-400" dir="rtl">{getOptionValue(opt, "AR")}</td>
                      <td className="px-4 py-2.5">
                        {opt.unit ? (
          ...
          {!editingOptionId && (addingOption ? (
            ...
            <button
              ...
              className="mt-3 inline-flex items-center gap-1.5 rounded-lg border border-dashed border-[#402F75] px-4 py-1.5 text-xs font-medium text-[#402F75] hover:bg-[#402F75]/5 dark:border-[#FBBB14] dark:text-[#FBBB14] dark:hover:bg-[#FBBB14]/5 transition-colors"
            >
  ...
  return (
    <div className="mb-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 overflow-hidden">
      ...
      <form onSubmit={handleSubmit} noValidate className="p-4 space-y-4">
        {apiError && (
          <div className="flex items-center gap-3 rounded-xl border border-red-200 bg-red-50 dark:border-red-800/40 dark:bg-red-500/5 px-4 py-2.5">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <select
              ...
              className={`h-9 w-full rounded-lg border bg-transparent px-4 text-sm text-gray-800 focus:outline-none focus:ring-3 dark:bg-gray-900 dark:text-white/90 ${
          ...
          <div>
            ...
            <input
              ...
              placeholder="RAM"
              className={`h-9 w-full rounded-lg border bg-transparent px-4 text-sm text-gray-800 focus:outline-none focus:ring-3 dark:bg-gray-900 dark:text-white/90 placeholder:text-gray-400 dark:placeholder:text-white/30 ${
        ...
        <button
          type="button"
          onClick={addOption}
          className="inline-flex items-center gap-1.5 rounded-lg border border-dashed border-[#402F75] px-4 py-2 text-xs font-medium text-[#402F75] hover:bg-[#402F75]/5 dark:border-[#FBBB14] dark:text-[#FBBB14] dark:hover:bg-[#FBBB14]/5 transition-colors"
        >
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
            <line x1="12" y1="5" x2="12" y2="19" />
            <line x1="5" y1="12" x2="19" y2="12" />
...
export default function Specs() {
  ...
  return (
    <>
      ...
      <div className="mb-4 rounded-xl border border-brand-200 dark:border-brand-700/30 bg-brand-50 dark:bg-brand-500/5 px-4 py-2">
