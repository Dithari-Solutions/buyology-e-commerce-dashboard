...
export default function NotFound() {
  return (
    <>
      ...
      />
      <div className="relative flex flex-col items-center justify-center min-h-screen p-4 overflow-hidden z-1">
        <GridShape />
        <div className="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
          <h1 className="mb-5 font-bold text-gray-800 text-title-md dark:text-white/90 xl:text-title-2xl">
            ERROR
          </h1>
          ...
          <p className="mt-10 mb-4 text-base text-gray-700 dark:text-gray-400 sm:text-base">
