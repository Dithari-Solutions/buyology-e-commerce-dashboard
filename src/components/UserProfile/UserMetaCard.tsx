...
export default function UserMetaCard() {
  ...
  return (
    <>
      <div className="p-4 border border-gray-200 rounded-xl dark:border-gray-800 lg:p-4">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-4 xl:flex-row">
            ...
            <div className="order-3 xl:order-2">
              <h4 className="mb-2 text-base font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">
                Musharof Chowdhury
              </h4>
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="flex h-9 w-9 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
              >
                <svg
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          ...
          <form className="flex flex-col">
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div>
                <h5 className="mb-4 text-base font-medium text-gray-800 dark:text-white/90 lg:mb-4">
                  Social Links
                </h5>
